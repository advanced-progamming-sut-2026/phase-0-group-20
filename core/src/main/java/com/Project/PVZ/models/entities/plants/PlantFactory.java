...
import com.Project.PVZ.models.entities.plants.PlantFoodStrategy.*;
import com.Project.PVZ.models.entities.plants.strategy.*;
import com.Project.PVZ.models.entities.plants.strategy.category_strategy.*;
import com.Project.PVZ.models.entities.plants.strategy.tag_strategy.ChargeStrategy;
import com.Project.PVZ.models.entities.plants.strategy.tag_strategy.MoveZombiesStrategy;
import com.Project.PVZ.models.entities.plants.strategy.tag_strategy.SleepStrategy;
import com.Project.PVZ.models.entities.plants.strategy.tag_strategy.TrapStrategy;
import com.Project.PVZ.models.entities.projectiles.HypnotizeEffect;
import com.Project.PVZ.models.entities.projectiles.LightningEffect;
import com.Project.PVZ.models.entities.projectiles.NormalEffect;
...
public class PlantFactory {
    ...
    private static void assembleThePlantFoodStrategy(Plant plant, String nameKey) {
        switch (nameKey) {
            case "citron" -> plant.addPlantFoodStrategy(new LaneClearFoodStrategy(
            ...
            case "sweet potato" -> plant.addPlantFoodStrategy(new FieldWideEffectFoodStrategy(
            ...
            case "wasabi whip" -> plant.addPlantFoodStrategy(new BurstEffectFoodStrategy(
                    "spinning whip across a 3x3 area"));
            case "kiwibeast" -> plant.addPlantFoodStrategy(new BurstEffectFoodStrategy(
