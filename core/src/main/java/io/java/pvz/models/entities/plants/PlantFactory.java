...
import io.java.pvz.models.entities.plants.PlantFoodStrategy.*;
...
import io.java.pvz.models.entities.plants.strategy.tag_strategy.MoveZombiesStrategy;
import io.java.pvz.models.entities.plants.strategy.tag_strategy.SleepStrategy;
...
public class PlantFactory {
    ...
    private static void handleTheBurst(Plant plant, PlantData data, String nameKey, int foodValue) {
        ...
        } else if (nameKey.equals("citron") || nameKey.equals("cactus")) {
